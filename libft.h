...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2014/11/03 14:07:27 by jcariou           #+#    #+#             */
/*   Updated: 2015/02/02 11:37:17 by jcariou          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
size_t				ft_strlcat(char *ds, char const *src, size_t size);
...
void				ft_lstdel(t_list **alst, void (*ddel)(void *, size_t));
